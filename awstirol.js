...
//..ein weitere Versuch der nicht funktioniert hat. Es taucht immer das gleiche Probblem auf. Nur eine Information kann angesprochen werden. 
/*var klimastationen = [
    {
        "name": "gehrenspitze",
        "temp": 0.6,
...
var output = "";
for(var i = 0;i<klimastationen.length;i++){
    output +="<ul><li>"+klimastationen[i].temp+"</li></ul>";
}
console.log(klimastationen[0].temp);
*/
//console.log(klimastationen.innerJavascript=output);
